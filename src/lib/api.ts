...
import { DashboardMetrics, Order, Pizza, User } from "../types";
...
export const mockPizzas: Pizza[] = [
  {
    ...
    name: "Margherita",
    description:
      "Molho de tomate, mozzarella fresca, manjericão e azeite extra virgem",
    price: 32.9,
  ...
  },
  {
    ...
    description:
      "Molho de tomate, mozzarella, presunto, cogumelos, alcachofras e azeitonas",
    price: 42.9,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/4/42/Pizza_Quattro_Stagioni_transparent.png",
    category: "especial",
    ingredients: [
      "molho de tomate",
      "mozzarella",
  ...
  },
  {
    ...
    description:
      "Molho de tomate, mozzarella, calabresa artesanal, cebola roxa e pimentão",
    price: 35.9,
    image:
      "https://media-cdn.tripadvisor.com/media/photo-s/07/88/0b/95/calabresa-especial-com.jpg",
    category: "brasileira",
    ingredients: [
      "molho de tomate",
      "mozzarella",
...
export const mockDashboardData: DashboardMetrics = {
  ...
  pizzasSold: 476,
  dailySales: [
    { date: "31/12", value: 2450.8, orders: 32 },
    { date: "01/01", value: 1890.5, orders: 25 },
    { date: "02/01", value: 3200.9, orders: 41 },
    { date: "03/01", value: 2750.3, orders: 35 },
    { date: "04/01", value: 4100.7, orders: 52 },
    { date: "05/01", value: 3650.2, orders: 47 },
